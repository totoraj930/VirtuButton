 ...
 */
export type PluginEventEmitter = <T extends PluginFieldMap = PluginFieldMap>(props: {
    eventId: string;
    pluginId?: string;
    buttonId?: string;
...
export type PluginInitProps = {
    ...
    updateItemViewProps: (itemId: string, props: Partial<ButtonViewProps>) => void;
    /**
 ...
 * フロントで使う用
 */
export type VBPluginSerialized = Omit<VirtuButtonPlugin, 'init' | 'events' | 'actions' | 'controlButtons'>;
